      ...
      <div className="flex items-center justify-center p-8 bg-white relative">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 mb-2">Welcome back!</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between pt-1">
              <div className="flex items-center space-x-2">
                ...
                <label className="text-sm font-medium text-gray-600 cursor-pointer select-none" htmlFor="remember">Remember for 30 days</label>
              </div>
              <a className="text-sm text-[#0d6efd] hover:text-blue-700 hover:underline font-bold transition-colors" href="#">Forgot password?</a>
            </div>
          ...
          <div className="text-center text-sm text-gray-500 mt-8 font-medium">
            Don't have an account? <Link className="text-gray-900 font-bold hover:underline" to="/register">Sign Up</Link>
          </div>
        </div>
      </div>
    </div>
