  ...
  return (
    <div className="min-h-screen max-h-screen overflow-hidden grid lg:grid-cols-2 bg-white font-sans text-gray-900">
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-gray-400 via-gray-500 to-gray-600 p-12 text-white overflow-hidden">
        ...
        <div className="relative z-20">
          <h2 className="text-[30px] font-extrabold tracking-tight leading-tight max-w-md">{t('register.heroTitle')}</h2>
      ...
      <div className="flex items-center justify-center p-8 bg-white relative">
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 mb-2">{t('register.title')}</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label className="text-sm font-bold text-gray-700" htmlFor="username">{t('register.username')}</label>
              <input
                type="text"
                id="username"
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-gray-700" htmlFor="email">{t('register.email')}</label>
              <input
                type="email"
                id="email"
                className="flex w-full rounded-full border border-gray-200 px-5 py-2 text-sm h-12 bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0d6efd]/20 focus:border-[#0d6efd] transition-all"
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-gray-700" htmlFor="nickname">{t('register.nickname')}</label>
              <input
                type="text"
                id="nickname"
                className="flex w-full rounded-full border border-gray-200 px-5 py-2 text-sm h-12 bg-white text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0d6efd]/20 focus:border-[#0d6efd] transition-all"
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-gray-700" htmlFor="password">{t('register.password')}</label>
          ...
          <div className="text-center text-sm text-gray-500 mt-8 font-medium">
            {t('register.haveAccount')} <Link className="text-gray-900 font-bold hover:underline" to="/login">{t('register.signIn')}</Link>
          </div>
        </div>
      </div>
    </div>
